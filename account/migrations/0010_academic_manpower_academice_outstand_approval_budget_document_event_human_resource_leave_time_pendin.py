...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0009_auto_20211019_2105'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.ManyToManyField(null=True, to='account.leave_time')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.ManyToManyField(null=True, to='account.Year')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(default='default.pdf', upload_to='uploads/%Y/%m/%d/')),
                ('year', models.ManyToManyField(null=True, to='account.Year_plan')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
